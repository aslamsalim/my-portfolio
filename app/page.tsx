  ...
  return (
    <>
      ...
      <p>
        ...
        design is a testament to my dedication to innovation, sustainability,
        and user-centricity. From residential gems to commercial landmarks,
        these projects showcase my commitment to crafting environments that
